...
###
    ...
    def with_perc_user_chart(self, with_users_df):
        with_users_df['perc_withdrawn_precise'] = round(round(with_users_df[with_users_df.has_withdrawn_p2]['WITHDRAWN_AMOUNT_PHASE2'],3)\
                                                            /with_users_df['deposited_p1']*100,2)
