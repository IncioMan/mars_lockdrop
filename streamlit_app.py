...
with col2:
    ...
    st.markdown("""50M $MARS tokens will be distributed among depositors. The longer you deposit, the higher the boost you obtain.""")
...
with col4:
    ...
    number2 = st.number_input('$MARS price')
